...
class Model(nn.Module):   
    ...
    def forward(self, input_ids=None, input_type_ids=None, input_pos_ids=None, 
                p_input_ids=None, p_input_type_ids=None, p_input_pos_ids=None,
                n_input_ids=None, n_input_type_ids=None, n_input_pos_ids=None,
                labels=None): 
        
        bs,_=input_ids.size()
        
        input_ids=torch.cat((input_ids,p_input_ids,n_input_ids),0)
        outputs=self.encoder(input_ids,attention_mask=input_ids.ne(self.tokenizer.pad_token_id))[1]
